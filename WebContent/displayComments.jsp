            ...
            <div class="col-lg-16">
                    <section class="panel">
                        <header class="panel-heading">
                            View Own Department Commment
                        </header>
                        <div class="form-group">
                          <form class="displayComments.jsp" >
...
<div class="container">     
 ...
 try
 {
	// String department=GetSet.getDept();
	 //String dept=GetSet.getDept();
	 PreparedStatement ps = con.prepareStatement("select * from comment where department_name=? ");
	 ps.setString(1,dept);
