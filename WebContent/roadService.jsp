...
-->
<%@page import="com.project.user.GetSet"%>
...
<head>
<title>Smart Maintenance Portal | View Data </title>
...
<section class="panel">
 <header class="panel-heading">
                            View Own Department Complaint
                        </header> 
  					<div class="form-group">
                          <form class="roadService.jsp" >
							 ...
							 int id=0;
							 Connection con = DatabaseConnectivityDemo.connectDb();
							// String dept=GetterSetterData.getDep();
							 String department_name= request.getParameter("select");
							 
							 try
							 {
								 PreparedStatement ps = con.prepareStatement("select * from user_complaint where department_name=?");
								 
								 ps.setString(1,department_name);
								 //ps.setString(1,GetterSetterData.getDept());
