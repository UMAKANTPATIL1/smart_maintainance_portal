...
<!DOCTYPE html>
<head>
<title>Smart Maintenance Portal | Pending Task </title>
...
<div class="top-nav clearfix">
    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                <img alt="" src="">
                <span class="username">Departmenr</span>
                <b class="caret"></b>
            </a>
...
<div class="container">     
 ...
 {
	 int id=0;
	 PreparedStatement ps = con.prepareStatement("select * from user_complaint where status=?");
...
%>
		 <tbody>
	      <tr>
	        ...
	        <td class="cell100 column4"><a href="approved_complaint.jsp?sr_No=<%=rs.getInt(1)%>">Approved</a></td>
	      </tr>
	      </tbody>
